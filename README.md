...
## О проекте
**Banking Widget** — учебный проект на Python для обработки банковских операций клиента. Проект демонстрирует работу с данными, маскирование конфиденциальной информации, фильтрацию, сортировку и анализ транзакций.

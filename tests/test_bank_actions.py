from src.actions_with_bank_operations import process_bank_operations, process_bank_search
...
def test_process_bank_operations_counts_correctly():
    ...
    assert result == {"Перевод организации": 2, "Оплата мобильной связи": 1, "Покупка в магазине": 1}
